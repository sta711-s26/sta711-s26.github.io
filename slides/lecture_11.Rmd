...
Let $X_1, X_2,...$ be iid random variables,  with $\mu = \mathbb{E}[X_i]$ and $\sigma^2 = Var(X_i) < \infty$. Let $\widehat{\sigma}^2$ be an estimate of $\sigma^2$ such that $\widehat{\sigma}^2 \overset{p}{\to} \sigma^2$. Then
