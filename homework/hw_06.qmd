...
5. Let's compare the method of moments and maximum likelihood estimators for $\alpha$.
    ...
    (h) Make a plot in R showing $ARE(\widehat{\alpha}_{\text{MLE}}, \widehat{\alpha}_{\text{MoM}})$ as a function of $\alpha$ (the `digamma` function in R will be useful!). What do you notice as $\alpha$ increases?
